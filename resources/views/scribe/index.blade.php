    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-auth-logout">Log Out  User</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-GETapi-auth-user">
                                <a href="#authentication-GETapi-auth-user">User Profile</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-PUTapi-auth-update_user">
                                <a href="#authentication-PUTapi-auth-update_user">Update user</a>
                            </li>
                                                                        </ul>
                            </ul>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="authentication">Authentication</h1>
                                ...
                                <h2 id="authentication-POSTapi-auth-logout">Log Out  User</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentication-GETapi-auth-user">User Profile</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentication-PUTapi-auth-update_user">Update user</h2>
